                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        >
                            ...
                            <div class="py-1">
                                ...
                                @if($currentTeam && in_array($billingPlan, ['team', 'business'], true))
                                <a href="{{ route('team.notifications', $currentTeam->id) }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    <svg class="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
